...
for (cn in c("Biologic_Agent", "Bone_Treatment_Agent", "Chemo_Agent", "Hormone_Agent", "Immuno_Agent", "Investigational_Agent", "Other_Agent", "Targeted_Agent")){
